...
#define mSLIDE_COLOR = color(0xD62020);
#define mSLIDE_ALPHA = .8;
#define mINVERSE_COLOR = color(0x205dd6);
...
MenuBase()
{
    ...
    while(bool(self.access))
    {
        ...
        if(self IsButtonPressed(SL_BUTTONS_ADS) || self IsButtonPressed(SL_BUTTONS_ATTACK))
        {
            self Scroll(self IsButtonPressed(SL_BUTTONS_ADS));
